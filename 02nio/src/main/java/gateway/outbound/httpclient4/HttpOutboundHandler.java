...
import gateway.router.AlwaysFirstHttpEndpointRouter;
...
public class HttpOutboundHandler {
    ...
    HttpEndpointRouter router = new AlwaysFirstHttpEndpointRouter();

    public HttpOutboundHandler(List<String> backends) {
        System.out.println("out bound handler");
    ...
    private void fetchGet(final FullHttpRequest inbound, final ChannelHandlerContext ctx, final String url) {
        System.out.println("proxy fetch url " + url);
        final HttpGet httpGet = new HttpGet(url);
        //httpGet.setHeader(HTTP.CONN_DIRECTIVE, HTTP.CONN_CLOSE);
        httpGet.setHeader(HTTP.CONN_DIRECTIVE, HTTP.CONN_KEEP_ALIVE);
        httpGet.setHeader("fanlu", inbound.headers().get("fanlu"));
